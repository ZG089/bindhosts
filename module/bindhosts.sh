...
custom_cron() {
	...
	# Has 5 args
		...
		while [ $x -lt 6 ] ; do
			...
			echo "[>] checking field #$x: [ $arg ]"
			valid_arg=false
			_is_valid_cron_arg "$x" "$arg" && valid_arg=true
